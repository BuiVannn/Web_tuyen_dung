...
//                 if (!data.created_at) {
//                     console.warn("Webhook 'user.created' received without 'created_at' field.");
//                     // Bạn có thể quyết định vẫn tạo user mà không có createdAt chính xác từ Clerk,
//                     // Mongoose timestamps sẽ tự tạo createdAt dựa trên thời gian server.
//                 }
